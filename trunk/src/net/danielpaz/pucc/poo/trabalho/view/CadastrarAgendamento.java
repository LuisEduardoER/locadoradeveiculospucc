...
public class CadastrarAgendamento extends JPanel {
	...
	public CadastrarAgendamento() {
	 ...
	 private void initComponents() {
	        ...
	        lbCadastrarAgendamento.setText("Cadastrar Agendamento");
	            ...
	            public void actionPerformed(java.awt.event.ActionEvent evt) {
	    	       ...
	    	       boolean erro;
	    	        ...
	    	        try {
	                    ...
	                    {
	                    	JOptionPane.showMessageDialog(null, "Será acrescentado 10% no Valor do Aluguel !");
	                    	Agendamento agendamento = new Agendamento (Integer.parseInt(tdCodigo.getText()), Integer.parseInt(tdCodigoVeiculo.getText()), Integer.parseInt(tdCodigoUsuario.getText()), tdDataInicial.getText(), tdDataFinal.getText(), Float.parseFloat(tdValor.getText()), 1);
	                    	...
	                    	if (agendamentoDAO.cadastrado(Integer.parseInt(tdCodigo.getText()))== true)
	                    	{
	                    		JOptionPane.showMessageDialog(null, "O codigo do Agendamento já existe, por favor verificar o código novamente.", TOOL_TIP_TEXT_KEY, WIDTH, null);
	                    		repaint();
	                    		return;
	                    	}
	                    	else
	        					...
	        					.addGroup(jPanel2Layout.createParallelGroup(Alignment.LEADING)
	        						...
	        						.addGroup(jPanel2Layout.createSequentialGroup()
	        							.addGroup(jPanel2Layout.createParallelGroup(Alignment.LEADING)
	        								...
	        								.addComponent(lbValor, GroupLayout.PREFERRED_SIZE, 40, GroupLayout.PREFERRED_SIZE))
	        							.addPreferredGap(ComponentPlacement.UNRELATED)
	        							.addGroup(jPanel2Layout.createParallelGroup(Alignment.LEADING)
