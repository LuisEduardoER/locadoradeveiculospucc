...
public class AlterarUsuario extends JPanel {
	...
	public AlterarUsuario() {
	 ...
	 private void initComponents() {
	        ...
	        lbCadastrarMarca.setText("Alterar Usu\u00E1rio");
	    	       ...
	    	       boolean erro;
	    	        ...
	    	        try {
	    	            ...
	    	            BD bd = new BD ("oracle.jdbc.driver.OracleDriver","jdbc:oracle:thin:@localhost:1521:xe","system", "poo2014");
	    	             ...
	    	             if (usuarioDAO.cadastrado(Integer.parseInt(tdCodigo.getText()))== false)
	    	             {
	    	                 JOptionPane.showMessageDialog(null, "O codigo do Usuario não existe, por favor verificar o código novamente.", TOOL_TIP_TEXT_KEY, WIDTH, null);
	    	                 repaint();
	    	                 return;
	    	             }
	    	             else
