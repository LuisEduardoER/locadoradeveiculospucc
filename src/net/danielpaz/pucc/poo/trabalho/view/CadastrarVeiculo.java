...
public class CadastrarVeiculo extends JPanel {
	...
	public CadastrarVeiculo() {
	 ...
	 private void initComponents() {
	        ...
	        lbCadastrarVeiculo.setText("Cadastrar Ve\u00EDculo");
	    	       ...
	    	       boolean erro;
	    	        ...
	    	        try {
                    	...
                    	TipoVeiculoDAO tipoVeiculoDAO = new TipoVeiculoDAO(bd);
	    	             ...
	    	             if (veiculoDAO.cadastrado(Integer.parseInt(tdCodigoVeiculo.getText()))== true)
	    	             {
	    	                 JOptionPane.showMessageDialog(null, "O codigo do Veiculo já existe, por favor verificar o código novamente.", TOOL_TIP_TEXT_KEY, WIDTH, null);
	    	                 repaint();
	    	                 return;
	    	             }
	    	             else
